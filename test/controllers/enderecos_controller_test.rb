...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference("Endereco.count") do
      post enderecos_url, params: { endereco: { city: @endereco.city, neighborhood: @endereco.neighborhood, number: @endereco.number, state: @endereco.state, street: @endereco.street } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { city: @endereco.city, neighborhood: @endereco.neighborhood, number: @endereco.number, state: @endereco.state, street: @endereco.street } }
